...
`})}),R=()=>(d.exports.useEffect(()=>{s.highlightAll()},[]),e(d.exports.Fragment,{children:[i(v,{title:"Divider",data:[{title:"Components"},{title:"Divider"}]}),e(c,{children:[i(r,{sm:"12",children:e(a,{title:"Default",code:D,children:[e(t,{children:["You can add a line to divide your section using ",i("code",{children:"<hr />"})," tag."]}),i(g,{})]})}),i(r,{sm:"12",children:e(a,{title:"Text",code:C,children:[e(t,{children:["Use class ",i("code",{children:".divider"})," as wrapper for ",i("code",{children:".divider-text"})," to create a divider text"]}),i(u,{})]})}),i(r,{sm:"12",children:e(a,{title:"Position",code:y,children:[e(t,{children:["Use class ",i("code",{children:".divider-[start | start-center | end | end-center]"})," with ",i("code",{children:".divider"})," to set text position."]}),i(f,{})]})}),i(r,{sm:"12",children:e(a,{title:"Colors",code:S,children:[e(t,{children:["Use class ",i("code",{children:".divider-[primary | secondary | success | danger | warnings | info | dark]"})," with"," ",i("code",{children:".divider"})," to set text position."]}),i(p,{})]})}),i(r,{sm:"12",children:i(a,{title:"Icons",code:F,children:i(N,{})})}),i(r,{sm:"12",children:e(a,{title:"Style",code:w,children:[e(t,{children:["use class ",i("code",{children:".divider-[dotted | dashed]"})," to change divider style. solid is default style you don't have to add any class for it."]}),i(x,{})]})})]})]}));export{R as default};
