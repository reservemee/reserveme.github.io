...
`})}),R=()=>(n.exports.useEffect(()=>{i.highlightAll()},[]),r(n.exports.Fragment,{children:[e(g,{title:"Badges",data:[{title:"Components"},{title:"Badges"}]}),r(o,{children:[e(d,{sm:"12",children:r(c,{title:"Contextual Badges",code:f,children:[r(s,{className:"mb-0",children:["Use prop ",e("code",{children:"color"})," with ",e("code",{children:"Badge"})," tag to create badge with different colors."]}),e(u,{})]})}),e(d,{sm:"12",children:r(c,{title:"Glow Badges",code:k,children:[r(s,{className:"mb-0",children:["Use class ",e("code",{children:"badge-glow"})," with ",e("code",{children:"Badge"})," tag to add glow effect to your badge"]}),e(h,{})]})}),e(d,{sm:"12",children:r(c,{title:"Light Badges",code:y,children:[r(s,{className:"mb-0",children:["Use prop ",e("code",{children:'color="light-COLOR_NAME"'})," with ",e("code",{children:"Badge"})," tag to create badge with different colors."]}),e(N,{})]})}),e(d,{sm:"12",children:e(c,{title:"Badges With Icons",code:w,children:e(p,{})})})]}),r(o,{children:[e(d,{md:"6",sm:"12",children:r(c,{title:"Link Badge",code:b,children:[r(s,{children:["Use ",e("code",{children:'href="#"'})," prop to use badge as a link."]}),e(t,{})]})}),e(d,{md:"6",sm:"12",children:r(c,{title:"Block Badge",code:S,children:[r(s,{children:["Use ",e("code",{children:".d-block"})," class to make badge display as block."]}),e(B,{})]})})]})]}));export{R as default};
