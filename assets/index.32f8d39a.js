...
export default AlertExample
        `})}),z=()=>(s.exports.useEffect(()=>{f.highlightAll()},[]),l(s.exports.Fragment,{children:[e(b,{title:"Alerts",data:[{title:"Components"},{title:"Alerts"}]}),l(v,{children:[e(r,{sm:"12",children:l(o,{title:"Default",code:C,children:[l(i,{children:["Alerts are available for any length of text, as well as an optional dismiss button. Use ",e("code",{children:"Alert"})," ","Component & ",e("code",{children:"color"})," prop for alert with all theme colors."]}),e(x,{})]})}),e(r,{sm:"12",children:l(o,{title:"Title",code:L,children:[l(i,{children:["Add a title to the alert with the ",e("code",{children:".alert-heading"})]}),e(y,{})]})}),e(r,{sm:"12",children:l(o,{title:"Colors",code:D,children:[l(i,{children:["Use ",e("code",{children:"color"})," prop to for alert with all theme colors."]}),e(I,{})]})}),e(r,{sm:"12",children:l(o,{title:"Dismissable Alert",code:F,children:[l(i,{children:["Using ",e("code",{children:"isOpen"})," and ",e("code",{children:"toggle"})," you can create a dismissable alert."]}),e(T,{})]})}),e(r,{sm:"12",children:l(o,{title:"Uncontrolled Alert",code:W,children:[e(i,{children:"For the most basic use-case an uncontrolled component can provide the functionality wanted without the need to manage/control the state of the component. UncontrolledAlert does not require isOpen nor toggle props to work."}),e(S,{})]})}),e(r,{sm:"12",children:e(o,{title:"Icon",code:q,children:e(k,{})})}),e(r,{sm:"12",children:l(o,{title:"Example",code:R,children:[e(i,{children:"An example would be to have an input and when a condition is met, show the alert."}),e(w,{})]})})]})]}));export{z as default};
