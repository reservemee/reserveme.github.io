import{r as l,j as e,cL as T,n as t,cM as y,cN as j,cO as x,cG as b,cz as I,cP as A,cC as H,cD as U,cQ as C,cB as N,cy as w,cg as P,a0 as $,a1 as o,a4 as B,a3 as u}from"./index.09005372.js";import{C as n}from"./index.5b58f7b3.js";import{B as K}from"./index.56e6378b.js";import{s as k,a as E}from"./05.826ce009.js";import{c as z}from"./08.f1bba1b6.js";import{I as R}from"./info.da30c367.js";import"./code.9f589fa8.js";const p=[{src:b,id:1},{src:I,id:2},{src:k,id:3}],D=()=>{const[r,c]=l.exports.useState(0),[a,i]=l.exports.useState(0),h=()=>{c(!0)},f=()=>{c(!1)},d=()=>{if(r)return;const s=a===p.length-1?0:a+1;i(s)},m=()=>{if(r)return;const s=a===0?p.length-1:a-1;i(s)},v=s=>{r||i(s)},S=p.map(s=>e(T,{onExiting:h,onExited:f,children:e("img",{src:s.src,className:"img-fluid",alt:s.id})},s.id));return t(y,{activeIndex:a,next:d,previous:m,keyboard:!1,children:[e(j,{items:p,activeIndex:a,onClickHandler:v}),S,e(x,{direction:"prev",directionText:"Previous",onClickHandler:m}),e(x,{direction:"next",directionText:"Next",onClickHandler:d})]})},g=[{src:H,id:1,header:"Slide 1",caption:"Donut jujubes I love topping I love sweet. Jujubes I love brownie gummi bears I love donut sweet chocolate. Tart chocolate marshmallow.Tart carrot cake muffin."},{src:z,id:2,header:"Slide 2",caption:"Tart macaroon marzipan I love souffl\xE9 apple pie wafer. Chocolate bar jelly caramels jujubes chocolate cake gummies. Cupcake cake I love cake danish carrot cake."},{src:U,id:3,header:"Slide 3",caption:"Pudding sweet pie gummies. Chocolate bar sweet tiramisu cheesecake chocolate cotton candy pastry muffin Marshmallow cake powder icing."}],M=()=>{const[r,c]=l.exports.useState(0),[a,i]=l.exports.useState(0),h=()=>{c(!0)},f=()=>{c(!1)},d=()=>{if(r)return;const s=a===g.length-1?0:a+1;i(s)},m=()=>{if(r)return;const s=a===0?g.length-1:a-1;i(s)},v=s=>{r||i(s)},S=g.map(s=>t(T,{onExiting:h,onExited:f,children:[e("img",{src:s.src,className:"img-fluid",alt:s.id}),e(A,{captionText:s.caption,captionHeader:e("span",{className:"text-white",children:s.header})})]},s.id));return t(y,{activeIndex:a,next:d,previous:m,keyboard:!1,interval:5e5,children:[e(j,{items:g,activeIndex:a,onClickHandler:v}),S,e(x,{direction:"prev",directionText:"Previous",onClickHandler:m}),e(x,{direction:"next",directionText:"Next",onClickHandler:d})]})},F=[{key:1,src:b,caption:"",altText:"Slide 1"},{key:2,src:I,caption:"",altText:"Slide 2"},{key:3,src:k,caption:"",altText:"Slide 3"}],G=()=>e(C,{items:F,keyboard:!1}),J=[{src:N,key:1,caption:"",altText:"Slide 1"},{src:w,key:2,caption:"",altText:"Slide 2"},{src:E,key:3,caption:"",altText:"Slide 3"}],L=()=>e(C,{items:J,interval:"500",keyboard:!1}),O=[{src:I,key:1,caption:"",altText:"Slide 1"},{src:N,key:2,caption:"",altText:"Slide 2"},{src:k,key:3,caption:"",altText:"Slide 3"}],Q=()=>e(C,{items:O,keyboard:!0}),Y=[{src:w,key:1,caption:"",altText:"Slide 1"},{src:I,key:2,caption:"",altText:"Slide 2"},{src:E,key:3,caption:"",altText:"Slide 3"}],q=()=>e(C,{items:Y,pause:"hover",keyboard:!1}),V=e("pre",{children:e("code",{className:"language-jsx",children:`
...
`})}),le=()=>(l.exports.useEffect(()=>{P.highlightAll()},[]),t(l.exports.Fragment,{children:[e(K,{title:"Carousel",data:[{title:"Components"},{title:"Carousel"}]}),t($,{children:[e(o,{className:"mb-1",sm:"12",children:e(B,{color:"info",children:e("div",{className:"alert-body",children:t("p",{children:[e(R,{className:"me-1",size:14}),"Nested carousels are not supported."]})})})}),e(o,{md:"6",sm:"12",children:e(n,{title:"Basic Example",code:V,children:e(D,{})})}),e(o,{md:"6",sm:"12",children:e(n,{title:"Captions Example",code:W,children:e(M,{})})}),e(o,{md:"6",sm:"12",children:t(n,{title:"Uncontrolled Example",code:X,children:[t(u,{children:["You don't have to manage state with ",e("code",{children:"UncontrolledCarousel"})," all you have to do is return it with your content."]}),e(G,{})]})}),e(o,{md:"6",sm:"12",children:t(n,{title:"Interval Example",code:Z,children:[t(u,{children:["Use ",e("code",{children:"Interval"})," prop to set interval between slides. default interval is ",e("strong",{children:"5000"}),"."]}),e(L,{})]})}),e(o,{md:"6",sm:"12",children:t(n,{title:"Keyboard Example",code:_,children:[t(u,{children:["Use ",e("code",{children:"Keyboard"})," prop to control carousel with keyboard default is ",e("code",{children:"false"}),"."]}),e(Q,{})]})}),e(o,{md:"6",sm:"12",children:t(n,{title:"Pause Example",code:ee,children:[t(u,{children:["Use ",e("code",{children:"pause"})," prop to pause carousel on hover."]}),e(q,{})]})})]})]}));export{le as default};
